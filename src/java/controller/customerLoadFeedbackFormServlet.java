 ...
 * @author nguye
 */
@WebServlet(name = "customerLoadFeedbackFormServlet", urlPatterns = {"/customerLoadFeedbackFormServlet"})
public class customerLoadFeedbackFormServlet extends HttpServlet {
    private final String ERROR_PAGE = "Error.html";
    private final String FEEDBACK_PAGE = "CustomerFeedback.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{            
            ...
            log("LoadFeedBackFormServlet_SQL: " + ex.getMessage());
        }
        catch (NamingException ex){
            log("LoadFeedBackFormServlet_Naming: " + ex.getMessage());
        }
        finally{
