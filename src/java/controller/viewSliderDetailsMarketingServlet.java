 ...
 * @author ASUS
 */
@WebServlet(name = "viewSliderDetailsMarketingServlet", urlPatterns = {"/viewSliderDetailsMarketingServlet"})
public class viewSliderDetailsMarketingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            log("viewSliderDetailsMarketingServlet _ SQL:" + ex.getMessage());
        }catch(NamingException ex){
            log("viewSliderDetailsMarketingServlet _ Naming:" + ex.getMessage());
        }finally{
